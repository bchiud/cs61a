...
def replace_leaf(t, old, new):
    ...
    "*** YOUR CODE HERE ***"
    l = label(t)
    return [new if l == old else l] + [replace_leaf(b, old, new) for b in branches(t)]
...
class Account:
    ...
    def time_to_retire(self, amount):
        ...
        "*** YOUR CODE HERE ***"
        # interest_balance, years = self.balance, 0
        # while interest_balance < amount:
        #     interest_balance *= 1 + self.interest
        #     years += 1
        # return years
        # using math
...
def make_joint(withdraw, old_password, new_password):
    ...
    """
    "*** YOUR CODE HERE ***"
    pass_chk = withdraw(0, old_password)
    if type(pass_chk) == str:
        return pass_chk
    def joint(amount, password):
        return withdraw(amount, old_password if password == new_password else password)
    return joint
