...
class Ant(Insect):
    ...
    def can_contain(self, other):
        # BEGIN Problem 9
        "*** YOUR CODE HERE ***"
        return True if self.container is True and other.container is False and self.ant is None else False
        # END Problem 9
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        for i in range(self.min_range, self.max_range +1):
            if current_place:
                if current_place != hive and current_place.bees != []:
...
class NinjaAnt(Ant):
    ...
    def action(self, colony):
        # BEGIN Problem 7
        "*** YOUR CODE HERE ***"
        damage_all_bees_in_place(self.place, self.damage)
        # END Problem 7
...
# END Problem 13
    ...
    def __init__(self, armor = 1):
        ...
        if not QueenAnt.has_queen:
            QueenAnt.has_queen, self.is_true_queen = True, True
        # END Problem 13
    ...
    def action(self, colony):
        ...
        # BEGIN Problem 13
        "*** YOUR CODE HERE ***"
        if self.is_true_queen is False:
            ...
            while current_place:
                ...
                if current_ant:
                    if current_ant not in self.double_damage_ants:
                        current_ant.damage *= 2
                        self.double_damage_ants += [current_ant]
                    if current_ant.container == True and current_ant.ant and current_ant.ant not in self.double_damage_ants:
                        current_ant.ant.damage *= 2
                        self.double_damage_ants += [current_ant.ant]
...
def damage_all_bees_in_place(place, damage):
    if place.bees:
        place.bees = [x for x in place.bees if damage < x.armor]
