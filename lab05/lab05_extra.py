...
def add_trees(t1, t2):
    ...
    if l1 < l2:
        b1 = branches(t1) + [tree(0) for _ in range(l2 - l1)]
        return add_trees(tree(label(t1), b1), t2)
    elif l1 > l2:
        b2 = branches(t2) + [tree(0) for _ in range(l1 - l2)]
        return add_trees(t1, tree(label(t2), b2))
    else:
